    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
        {wishes?.map((wish) => (
          <div
            key={wish._id}
            className="card xl:card-side bg-blue-100 shadow-xl pl-2 mb-8"
          >
            <figure>
              <img id="image" src={wish.image} />
            </figure>
            <div className="card-body ">
              ...
              <p id="short_des">
                ...
                {wish.short_description}
              </p>
              <p id="category">
                <span className="font-bold">Category:</span> {wish.category}
              </p>
