...
const AddBlogs = () => {
    ...
    const handleSubmit = e => {
        ...
        const newBlog = { title, image, category, short_description, long_description, time, email, name, profile_pic }
        ...
        <div>
            ...
            <div className="w-1/2 mx-auto bg-green-200 p-8">
                <form onSubmit={handleSubmit}  >
                    ...
                    <input className="w-full p-2" placeholder="Title" type="text" id="title" name="title" required />
                    <br />
                    <br />

                    <label htmlFor="image_url">Image URL:</label>
                    <input className="w-full p-2" placeholder="Image URL " type="text" id="image_url" name="image" required /><br /><br />
                    ...
                    <textarea className="w-full p-2" id="short_description" name="short_description" rows='2' required></textarea><br /><br />
